...
<!-- title图片 -->
			...
			<div id="mycar-xinxi">
				...
				<div id="xinxi">
					...
					<table border="0" cellspacing="20" cellpadding="15" style="font-size: 14px;">
						<tr>
							<td>姓名</td>
							<td><input type="text" name="" id="" disabled="disabled"  value="${dingdanq.uname }" /></td>
						</tr>
						<tr>
							<td>地址</td>
							<td><input type="text" name="" id="" disabled="disabled" value="${dingdanq.shen }，${dingdanq.shi }，${dingdanq.qu }" /></td>
						</tr>
						<tr>
							<td>电话</td>
							<td><input type="text" name="" id="" disabled="disabled" value="${dingdanq.tel }" /></td>
						</tr>
					</table>
	...
	<script type="text/javascript">
		...
		function adddingdan()
		{
			location.href="${pageContext.request.contextPath}/adddingdanServlet";
		}
